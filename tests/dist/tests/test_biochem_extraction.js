...
async function testExtraction() {
    var _a;
    const provider = new local_extraction_provider_1.LocalExtractionProvider();
    const res = await provider.extractMedicalData(ocrText);
    console.log('Extracted labs count:', (_a = res.labResults) === null || _a === void 0 ? void 0 : _a.length);
