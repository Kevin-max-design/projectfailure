...
exports.RelevantMedicalHistoryService = void 0;
class RelevantMedicalHistoryService {
    /**
     * Retrieves prior patient records potentially relevant to the current symptoms
     * based on structured heuristics.
     */
    static async retrieveRelevantHistory(patientId, context, dbClient, isDemo = false) {
        var _a;
        ...
        const searchString = `${context.reason_category} ${context.problem_location || ''} ${((_a = context.selected_symptoms) === null || _a === void 0 ? void 0 : _a.join(' ')) || ''} ${context.patient_description || ''}`.toLowerCase();
        // Define locations
        ...
        diagnoses.forEach((dx) => {
            ...
            if (relevanceReason) {
                matchedRecords.push({
                    ...
                    type: 'diagnosis',
                    title: dx.name,
                    date: ((_a = dx.medical_records) === null || _a === void 0 ? void 0 : _a.event_date) || dx.event_date || new Date().toISOString().split('T')[0],
        ...
        medications.forEach((med) => {
            ...
            if (!isHistorical) {
                ...
                matchedRecords.push({
                    ...
                    date: med.start_date || ((_a = med.medical_records) === null || _a === void 0 ? void 0 : _a.event_date) || new Date().toISOString().split('T')[0],
        ...
        labResults.forEach((lab) => {
            ...
            if (relevanceReason) {
                matchedRecords.push({
                    ...
                    date: lab.test_date || ((_a = lab.medical_records) === null || _a === void 0 ? void 0 : _a.event_date) || new Date().toISOString().split('T')[0],
        ...
        procedures.forEach((proc) => {
            ...
            if (relevanceReason) {
                matchedRecords.push({
                    ...
                    type: 'procedure',
                    title: proc.name,
                    date: proc.date || ((_a = proc.medical_records) === null || _a === void 0 ? void 0 : _a.event_date) || new Date().toISOString().split('T')[0],
        ...
        if (patientData && patientData.known_allergies) {
            patientData.known_allergies.forEach((alg) => {
        ...
        // Extract Blood Group
        let bloodGroup = { value: 'Unknown', provenance: 'unknown' };
        if (patientData && patientData.blood_group) {
            ...
            const hasVerifiedBloodGroupLab = labResults.some((l) => l.test_name.toLowerCase().includes('blood group') ||
...
exports.RelevantMedicalHistoryService = RelevantMedicalHistoryService;
