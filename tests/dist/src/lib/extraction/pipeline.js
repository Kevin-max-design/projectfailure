...
exports.DocumentProcessingPipeline = void 0;
...
class DocumentProcessingPipeline {
    constructor(options) {
        this.ocrProvider = (0, provider_factory_1.createOCRProvider)();
        this.extractionProvider = (0, provider_factory_1.createExtractionProvider)();
        this.classifier = new classifier_1.DocumentClassifier();
        this.extractors = new extractors_1.SpecializedExtractors();
        this.validator = new validator_1.DeterministicValidator();
    }
    getExtractionMethod() {
     ...
     */
    async processDocument(documentId, fileBuffer, mimeType, supabase, bypassSplit = false) {
        var _a;
        try {
            ...
            const { data: docData } = await supabase
                ...
                .eq('id', documentId)
                .single();
            const patientId = docData === null || docData === void 0 ? void 0 : docData.patient_id;
            const category = (docData === null || docData === void 0 ? void 0 : docData.category) || 'Auto Detect';
            const originalFilename = (docData === null || docData === void 0 ? void 0 : docData.file_name) || 'document.png';
            // STAGE A: Faithful Document Capture (OCR & Preprocessing)
            await this.updateStatus(supabase, documentId, 'preprocessing');
            let processedBuffer = fileBuffer;
            let rotationAngle = 0;
            let normalizedStoragePath = null;
            let ocrResult = null;
            ...
            if (!ocrResult) {
                ...
                if (!(0, mode_1.isDemoMode)() && mimeType.startsWith('image/') && !isLocalProvider) {
            ...
            for (const page of ocrResult.pages) {
                let pageNormalizedPath = null;
                let pageOriginalPath = null;
                ...
                else if (page.pageNumber === 1 && (docData === null || docData === void 0 ? void 0 : docData.storage_path)) {
                ...
                await supabase.from('document_pages').insert({
                    ...
                    ocr_provider: ocrResult.engine || 'paddleocr',
                    fallback_provider: ocrResult.engine === 'tesseract' ? null : 'tesseract'
                });
            }
            ...
            if (!bypassSplit && ocrResult.detectedRegions && ocrResult.detectedRegions.length > 1) {
                ...
                const minConfidence = Math.min(...ocrResult.detectedRegions.map((r) => r.confidence || 1.0));
                if (minConfidence < 0.85) {
                    ...
                    await supabase
                        ...
                        metadata: {
                            detectedRegions: ocrResult.detectedRegions.map((r) => ({
                                regionId: r.regionId,
            ...
            if (classification.documentType === 'NEEDS_REVIEW') {
                ...
                extraction = Object.assign({ documentType: classification.documentType, classificationConfidence: classification.confidenceScore, classificationSource: 'llm', documentTitle: { value: classification.documentType.replace(/_/g, ' '), confidence: classification.confidenceScore, sourceText: classification.explanation, page: 1 }, documentDate: { value: null, confidence: 1.0, sourceText: null, page: 1 }, patientNameOnDocument: classification.patientName ? { value: classification.patientName, confidence: 0.95, sourceText: classification.patientName, page: 1 } : undefined, hospitalName: classification.hospitalName ? { value: classification.hospitalName, confidence: 0.95, sourceText: classification.hospitalName, page: 1 } : undefined }, extractedData);
            }
            ...
            if (ocrResult.rawText && ocrResult.rawText.trim()) {
                ...
                extraction.coverageMetrics = {
                    ...
                    unreadableBlocks: ((_a = extraction.unreadableSections) === null || _a === void 0 ? void 0 : _a.length) || 0
                };
            }
    ...
    async detectImageRotation(fileBuffer, mimeType) {
        var _a, _b;
    ...
    async updateStatus(supabase, documentId, status, errorMessage) {
        const updatePayload = {
    ...
    getInitialVerificationStatus(confidence) {
    ...
    async createUnverifiedTimelineEvents(supabase, documentId, patientId, extraction) {
        var _a, _b, _c, _d, _e;
        const eventDate = extraction.documentDate.value || new Date().toISOString().split('T')[0];
        let eventType = 'Doctor Visit';
        ...
        await supabase.from('medical_events').insert({
            ...
            hospital_name: ((_a = extraction.hospitalName) === null || _a === void 0 ? void 0 : _a.value) || null,
            doctor_name: ((_b = extraction.doctorName) === null || _b === void 0 ? void 0 : _b.value) || null,
            summary: `Document processed. Contains ${((_c = extraction.diagnoses) === null || _c === void 0 ? void 0 : _c.length) || 0} diagnoses, ${((_d = extraction.medications) === null || _d === void 0 ? void 0 : _d.length) || 0} medications, and ${((_e = extraction.labResults) === null || _e === void 0 ? void 0 : _e.length) || 0} lab results.`,
            source_document_id: documentId,
            verification_status: 'pending_review'
        });
    }
    async splitDocument(parentId, regions, parentDocData, supabase) {
